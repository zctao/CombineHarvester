...
void makePostFitPlots_2l_2tau_mvaOutput_noHTT_SUM_VT()
{
  gROOT->SetBatch(true);
  ...
  categories.push_back("ttH_2l_2tau_prefit");
  categories.push_back("ttH_2l_2tau_postfit");
  ...
  inputFileNames["ttH_2l_2tau_prefit"]  = "ttH_2l_2tau_mvaOutput_noHTT_SUM_VT_shapes.root";
  inputFileNames["ttH_2l_2tau_postfit"] = "ttH_2l_2tau_mvaOutput_noHTT_SUM_VT_shapes.root";
  ...
  for ( std::vector<std::string>::const_iterator category = categories.begin();
    ...
    */
    ...
    std::string outputFileName = Form("%s/makePostFitPlots_%s_mvaOutput_noHTT_SUM_VT.pdf", outputFilePath.data(), category->data());
