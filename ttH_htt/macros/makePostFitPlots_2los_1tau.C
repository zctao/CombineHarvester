...
void makePostFitPlots_2los_1tau()
{
  gROOT->SetBatch(true);
  ...
  categories.push_back("ttH_2los_1tau_prefit");
  categories.push_back("ttH_2los_1tau_postfit");

  std::string inputFilePath = string(getenv("CMSSW_BASE")) + "/src/CombineHarvester/ttH_htt/datacards/2los_1tau/";
  std::map<std::string, std::string> inputFileNames; // key = category
  inputFileNames["ttH_2los_1tau_prefit"]  = "ttH_2los_1tau_mvaDiscr_2los_2016_shapes.root";
  inputFileNames["ttH_2los_1tau_postfit"] = "ttH_2los_1tau_mvaDiscr_2los_2016_shapes.root";
