...
void makePostFitPlots_2l_2tau_mTauTauVis()
{
  gROOT->SetBatch(true);
  ...
  inputFileNames["ttH_2l_2tau_prefit"]  = "ttH_2l_2tau_mTauTauVis_shapes.root";
  inputFileNames["ttH_2l_2tau_postfit"] = "ttH_2l_2tau_mTauTauVis_shapes.root";
  ...
  for ( std::vector<std::string>::const_iterator category = categories.begin();
    ...
    */
    ...
    std::string outputFileName = Form("%s/makePostFitPlots_%s_mTauTauVis.pdf", outputFilePath.data(), category->data());
